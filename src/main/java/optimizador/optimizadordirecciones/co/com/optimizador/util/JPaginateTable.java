...
/**
 * Define un objeto table pero con paginación.
 * 
 * @author Yesid Ferrer
 * @version 1.0
 */
public class JPaginateTable extends JTable {
	 ...
	 * Logger de la clase.
	 */
	private static final Logger LOGGER = Logger.getLogger(JPaginateTable.class);
	...
	/**
	 * Método que define las propiedades generales de la tabla.
	 */
	...
	/**
	 * Define el modelo a ser utilizado por la tabla.
	 * 
	 * @param columnNames
	...
	/**
	 * Permite definir los escuchadores de eventos para la tabla.
	 */
	...
	/**
	 * Define los filtros adecuados para los botones.
	 * 
	 * @param paginateSorter
	 *            el sorter del paginador.
	 */
	public void initFilterAndButton(TableRowSorter<TableModel> paginateSorter,
		...
		paginateSorter.setRowFilter(new RowFilter<TableModel, Integer>() {
			...
			public boolean include(
				...
				return ti * rowMaxSort <= ei
						&& ei < ti * rowMaxSort + rowMaxSort;
			}
		});
	...
	/**
	 * @param x
	 *            posicion de coordenada x en el frame.
	 * @param y
	 *            posicion de coordenada x en el frame.
	 * @param width
