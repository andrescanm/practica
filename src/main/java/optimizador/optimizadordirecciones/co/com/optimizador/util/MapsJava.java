...
/**
 * Clase padre desde donde se extienden el resto. Sirve principalmente para
 * asignar/obtener propiedades básicas a la hora de realizar una petición
 * (clave, sensor, idioma, etc.) y para obtener un registro de todas las
...
public abstract class MapsJava {
	...
	private static String region = "co";
	...
	protected abstract void storeInfoRequest(URL urlRequest, String info,
			String status, Exception exception);

	// Protected methods
	private static int numRequest = 0;

	protected void storageRequest(String urlRequest, String info,
			String status, Exception exception) {
		Date date = new Date();
		numRequest += 1;
		MapsJava.stockRequest = (String[][]) (this.resizeArray(
				MapsJava.stockRequest, numRequest));
	 ...
	 * 
	 * @param key
	 *            clave de desarrollador API Google Maps
	 * @return devuelve el estado de una petición con clave API. En caso de ser
	 *         válida, devuelve "OK", en cualquier otro caso la clave no es
	 *         correcta.
	...
	public static String APIkeyCheck(String key) {
		try {
			URL url = new URL(
					"https://maps.googleapis.com/maps/api/place/search/xml?location=0,0&radius=1000"
			...
			NodeList nodeLatLng = (NodeList) xpath.evaluate(
					"PlaceSearchResponse/status", document,
	 ...
	 *            asigna tiempo máximo de conexión
	 ...
	 * 
	 * @param aLanguage
	 *            establece el idioma de resultados
	 ...
	 * 
	 * @param aSensor
	 *            en caso de ser true, se fuerza a utilizar sensor. Si es false,
	 *            no se utiliza
	 ...
	 * 
	 * @param aKey
	 *            string con clave API de desarrollador
	 * @see MapsJava#getKey()
	 * @see MapsJava#APIkeyCheck(java.lang.String)
	 */
	 ...
	 * Ejemplo:<br/>
	 * [0][0]="1";<br/>
	 * [0][1]="Mon Oct 07 11:30:31 CEST 2013";<br/>
	 * [0][2]="OK";<br/>
	 * [0][3]=""http://maps.google.com/maps/api/geocode/xml?address=Madrid&
	 * region=es&language=es&sensor=false"";<br/>
	 * [0][4]="Geocoding request";<br/>
	 * [0][5]="No exception";<br/>
	 * Tipos de status:<br/>
	 ...
	 * String[6] con la siguiente estructura:</br> [0]="Número de petición";<br/>
	 * [1]="Fecha/hora petición";<br/>
	 * [2]="status de la petición";<br/>
	 * [3]="URL de la petición";<br/>
	 * [4]="Información sobre petición realizada";<br/>
	 * [5]="Excepciones generadas";<br/>
	 * Ejemplo:<br/>
	 * [0]="1";<br/>
	 * [1]="Mon Oct 07 11:30:31 CEST 2013";<br/>
	 * [2]="OK";<br/>
	 * [3]=
	 * "http://maps.google.com/maps/api/geocode/xml?address=Madrid&region=es&language=es&sensor=false"
	 * ;<br/>
	 * [4]="Geocoding request";<br/>
	 * [5]="No exception";<br/>
	 * Tipos de status:<br/>
	 * OK: indica que la solicitud del API se realizó correctamente.<br/>
	 * INVALID_REQUEST: indica que la solicitud del API se formó de forma
	...
	public static String[] getLastRequestRequest() {
		...
		System.arraycopy(stockRequest[stockRequest.length - 1], 0,
				stockRequestTemp, 0, 6);
